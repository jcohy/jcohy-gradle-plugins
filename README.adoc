...
* jcohy-java-checkstyle：一个 checkstyle 插件。集成 alibaba,sun,google,spring 和 jcohy（此项目自定义提供） 代码检查规范。请参考 link:src/docs/asciidoc/conventions.adoc[jcohy-java-checkstyle] 获取更多信息
