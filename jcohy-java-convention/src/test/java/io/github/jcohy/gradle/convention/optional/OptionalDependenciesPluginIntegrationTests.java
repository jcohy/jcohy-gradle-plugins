...
package io.github.jcohy.gradle.convention.optional;
...
public class OptionalDependenciesPluginIntegrationTests {
    ...
    void optionalConfigurationIsCreated() throws IOException {
        try (PrintWriter out = new PrintWriter(new FileWriter(this.buildFile))) {
            out.println("plugins { id 'io.github.jcohy.optional-dependencies' }");
    ...
    public void optionalDependenciesAreAddedToSourceSetClasspath(String sourceSet, String classpath)
        ...
        try (PrintWriter out = new PrintWriter(new FileWriter(this.buildFile))) {
            out.println("plugins {");
            out.println("    id 'io.github.jcohy.optional-dependencies'");
            out.println("    id 'java'");
            out.println("}");
