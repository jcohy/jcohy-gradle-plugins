...
checkstyle "io.github.jcohy:jcohy-java-checkstyle:${version}"
----
...
<module name="com.puppycrawl.tools.checkstyle.Checker">
	<module name="io.github.jcohy.checkstyle.JcohyChecks" />
</module>
----
...
检查导入顺序是否遵循 jcohy 约定. 定义了 `projectRootPackage` 属性。配置项目的根包。默认为 `io.github.jcohy`.定义了如下属性。
...
<module name="com.puppycrawl.tools.checkstyle.Checker">
	<module name="com.puppycrawl.tools.checkstyle.TreeWalker">
		<module name="io.github.jcohy.checkstyle.check.SpringJUnit5Check">
		</module>
 	</module>
</module>
...
package io.github.jcohy.javaformat.checkstyle;
