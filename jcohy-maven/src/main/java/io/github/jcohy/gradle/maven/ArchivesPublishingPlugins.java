...
public class ArchivesPublishingPlugins implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ArchivesPublishingExtension extension = project.getExtensions().create(ArchivesPublishingExtension.JCOHY_MAVEN_PUBLISHING_EXTENSION_NAME, ArchivesPublishingExtension.class);
    }
