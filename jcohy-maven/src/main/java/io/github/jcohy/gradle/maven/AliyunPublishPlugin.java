    ...
    public void apply(Project project) {
        ...
        publishingExtension.getRepositories().maven(mavenRepository -> {
            ...
            mavenRepository.credentials((passwordCredentials -> {
                passwordCredentials.setUsername(Utils.getProperties(project, "USERNAME", PomConstant.NEXUS_USER_NAME));
                passwordCredentials.setPassword(Utils.getProperties(project, "PASSWORD", PomConstant.NEXUS_USER_NAME));
            }));
        });
    }
}
